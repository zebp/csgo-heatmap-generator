// This is taken out of https://github.com/pasu/squishjs, they do not exist on npm.
...
function Unpack565(packed0: any, packed1: any, colour: any, offset: any){
...
function DecompressColour(rgba: any, block: any, nOffset: any, isDxt1: any){
...
function DecompressAlphaDxt3(rgba: any, block: any , nOffset: any){
    // unpack the alpha values pairwise
    for( var i = 0; i < 8; ++i )
    {
        // quantise down to 4 bits
        var quant = block[nOffset + i];
...
function DecompressAlphaDxt5(rgba: any, block: any, nOffset: any){
...
function Decompress(rgba: any, block: any, nOffset: any, flags: any){
    var nOffset2 = 0;
...
function DecompressImage565(rgb565: any, width: any, height: any, blocks: any) {
 ...
 */
function DecompressImage(rgba: any, width: any, height: any, blocks: any, flags: any){
...
export default function toRgbaBuffer(out: Uint8Array, width: number, height:  number, block: any, flags: any){
